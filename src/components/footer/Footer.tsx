            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
              ...
              <div className="mb-5">
                ...
                <form className="flex flex-row flex-wrap">
                  <input
                    type="text"
                    className="text-meddium-gray-footer rounded-sm pb-3 w-2/3 p-2 focus:border-meddium-orange"
                    placeholder="email@exemplo.com"
                    name=""
                    id=""
                  ></input>
                  <button className="p-2 w-1/3 bg-meddium-orange text-white-new hover:bg-dark-orange">
                    Se inscrever
                  </button>
                </form>
              </div>
        ...
        <div className="w-full bg-dark-gray-footer text-meddium-gray-footer px-10">
          <div className="max-w-7xl flex flex-col sm:flex-row py-4 mx-auto justify-between items-center">
            <div className="text-center">
              <div>
                <p>
                  Copyright ©️ 2024 <b>Nosso pomar</b> Todos os direitos
                  reservados
                </p>
              </div>
              <div>
                <p>
                  Feito com amor pelo{" "}
                  <span className="text-meddium-orange"> Grupo 4</span>{" "}
                </p>
              </div>
            </div>
