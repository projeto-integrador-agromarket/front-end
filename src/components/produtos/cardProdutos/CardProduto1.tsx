        ...
        <>
            <div className="relative m-10 flex w-full max-w-sm flex-col overflow-hidden rounded-lg border border-light-gray-card bg-white-new shadow-2xl hover:bg-light-gray-card">
                ...
                <div className="mt-4 px-5 pb-5">
                    <a href="#">
                        <h5 className="text-2xl font-semibold tracking-tight text-slate-900">{produto.nome}</h5>
                    </a>
                    ...
                    <div className="vendedor mb-5 flex flex-row items-center">
                        ...
                        <p><b>Vendido por:</b> <span>{produto.usuario?.nome}</span></p>
                    </div>
                    <div className="grid grid-cols-2 gap-5">
                                            ...
                                            <div className="grid grid-cols-1 gap-5">
                                                ...
                                                <a href="#" className="flex items-center justify-center rounded-md bg-meddium-green px-2 py-2.5 text-center text-sm font-bold text-white-new hover:bg-dark-green-login focus:outline-none focus:ring-4 focus:ring-blue-300">
                                                    ...
                                                    <button className="bg-new-green hover:bg-new-dark-green text-white font-semibold py-2 px-4 rounded mr-5 mb-1"
                                                        onClick={() => adicionarProduto(produto)}><MdAddShoppingCart size={28} /></button></a>
                                            </div>
                        ...
                        <a href="#" className="flex items-center justify-center rounded-md bg-new-green px-2 py-2.5 text-center text-sm font-bold text-white-new hover:bg-dark-green-login focus:outline-none focus:ring-4 focus:ring-blue-300">
                            {/* <svg xmlns="http://www.w3.org/2000/svg" className="mr-2 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                            </svg> */}
                            <button className="bg-new-green hover:bg-new-dark-green text-white font-semibold rounded mr-5 mb-0"
                                onClick={() => adicionarProduto(produto)}><MdAddShoppingCart size={28} className="hover:bg-dark-green"/></button></a>
                    </div>
